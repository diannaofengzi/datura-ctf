...
topics = ["Scanning", "Services and Ports", "Reverse Shell", "Privilege Escalation", "Binary Exploitation", "Classic Exploits", "Reverse Engineering", "Forensics",  "Cryptography", "Web", "Steganography", "PDF Files", "ZIP Files", "Hashes", "OSINT", "Network", "Jail Break", "Android", "Esoteric Languages", "Data Science", "Signal processing", "Chemistry", "Other CheatSheets"]
